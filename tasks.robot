...
FillAndSubmitTheFormWithData
    ...
    #Wait Until Element Is Visible  //div[@id='robot-preview']  ${stdWait}
    ...
    #Wait Until Element Is Visible    //button[normalize-space()='Show performance']
    #Click Button    //button[normalize-space()='Show performance']
...
CreatePDF
    ...
    #IF    ${Alert}
    #    ${Orderidxpath}=  Convert To String  //div[@role='alert']
    #END
    ...
    #IF    ${Alert}
        #Sleep    15s
        #Wait Until Element Is Visible    //button[normalize-space()='I guess so...']  ${stdWait}
        #Click Button    //button[normalize-space()='I guess so...']
    #ELSE
        #Sleep    5s
